...
1. Загрузите папку `/floc` к себе на компьютер.
2. Установите (`chrome://extensions/`) это расширение (нужно сперва поставить галку "Режим разработчика").
3. Откройте сайт, который вы хотели бы проверить.
4. Нажмите на кнопку расширения.
