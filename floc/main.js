  ...
  var code = "" +
    ...
    "while(a=w.nextNode()) {" +
      "if(a.parentElement.tagName !== 'STYLE' && a.textContent.trim().length) {" +
        "a.textContent='The longest non-technical word in major dictionaries is floccinaucinihilipilification at 29 letters.'" +
      "}" +
    "}";
...
function addLargeImages() {
  var code = "" +
    "javascript:" +
    "var a,w=document.createTreeWalker(document,NodeFilter.SHOW_ELEMENT);" +
    "while(a=w.nextNode()) {" +
      "if(a.tagName === 'IMG') {" +
        "a.src='http://lorempixel.com/g/1920/1400'" +
      "}" +
    "}";
